...
public class PatternAnalysisService {
    ...
    private List<Prediction> buildPredictions(Map<Integer, List<String>> confirmations, 
        ...
        Set<Integer> alreadyAppeared = new HashSet<>(historicalNumbers);
        ...
        for (Map.Entry<Integer, List<String>> entry : confirmations.entrySet()) {
            ...
            if (!reasons.isEmpty()) {
                ...
                // Slight penalty for numbers that already appeared
                double probability = alreadyAppeared.contains(number) 
                        ? baseProbability * 0.9 
                        : baseProbability;
